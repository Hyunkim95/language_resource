...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post languages_url, params: { language: { title: @language.title, user_id: @language.user_id } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { title: @language.title, user_id: @language.user_id } }
